# -*- coding: utf-8 -*-
"""
Created on Thu Mar 23 17:31:17 2023
...
model=load(open(r"C:\\Users\\DELL\\Resume Classification\\model (1).sav",'rb'))
model1=load(open(r"C:\\Users\\DELL\\Resume Classification\\model_id (1).pkl",'rb'))
...
def extract_skills(resume_text):
    ...
    data = pd.read_csv("C:\\Users\\DELL\\Resume Classification\\skills.csv") 
